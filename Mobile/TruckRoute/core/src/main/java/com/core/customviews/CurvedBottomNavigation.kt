...
class CurvedBottomNavigation : BottomNavigationView {
    ...
    private fun init() {
        ...
        mPaint?.color = context.getColor(R.color.white_F8F7F7)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        mPaint?.color = context.getColor(R.color.grey_A6A6A6)

        val border: Paint = mPaint ?: Paint()
